--List the following details of each employee: last name, first name, gender, and salary.
...
--List all employees in the Sales departments, including their employee number, last name, 
--first name, and department name.
